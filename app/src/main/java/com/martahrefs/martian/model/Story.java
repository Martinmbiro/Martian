...
public class Story {
    /*This class will create and hold the array of pages for us*/
    // Create an Array of Page object, then we'll load our actual story data into each page
    private Page[] mPages;

    // A method to initialize the story hence we make a constructor where we create our array and fill it with data
    public Story (){
        mPages = new Page[7];
    ...
    // This method will return a page number at a specific index
